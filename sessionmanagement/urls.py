...
from .views import (dashboard_view, delete_post, edit_post, home_view,
                    post_add, semester_add_view, semester_delete_view,
                    semester_list_view, semester_update_view, session_add_view,
                    session_delete_view, session_list_view,
                    session_update_view)
