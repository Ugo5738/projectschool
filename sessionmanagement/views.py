...
from sessionmanagement.forms import (NewsAndEventsForm, SemesterForm,
                                     SessionForm)
from sessionmanagement.models import *
...
def home_view(request):
    ...
    context = {
        'title': "News & Events | Project School",
        'items': items,
    }
...
def edit_post(request, pk):
    ...
    return render(request, 'app/post_add.html', {
        'title': 'Edit Post | Project School',
        'form': form,
    })
